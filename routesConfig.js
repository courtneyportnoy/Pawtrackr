...
module.exports = function(app) {
    ...
    // GET /auth/foursquare
    app.get('/foursquare', passport.authenticate('foursquare'), function(request, response){
    // The request will be redirected to Foursquare for authentication, so this
    // function will not be called.
    });
    
    //   which, in this example, will redirect the user to the home page.
    app.get('/foursquare/callback', passport.authenticate('foursquare', { failureRedirect: '/login' }), function(request, response) {
